...
@section('content')
<div class="x-body">
	<blockquote class="layui-elem-quote">上传新闻</blockquote>
	<div class="layui-card-body" style="padding: 15px;">
		<form class="layui-form" action="{{ url('/backend/dynamic/news-adds') }}" method="post" enctype='multipart/form-data' lay-filter="component-form-group" autocomplete="off">
			@csrf
			<div class="layui-form-item">
				<label class="layui-form-label">新闻标题</label>
				<div class="layui-input-block">
					<input type="text" name="title" lay-verify="title" value="{{ old('title') }}"  autocomplete="off" placeholder="请输入标题" class="layui-input">
				</div>
			</div>
      <div class="layui-form-item">
        <label class="layui-form-label">新闻推荐关键字</label>
        <div class="layui-input-block">
          <input type="text" name="key" lay-verify="key" value="{{ old('key') }}"  autocomplete="off" placeholder="相关新闻推荐关键字如 : 油漆,定制家具... (词汇请简洁 最好一个关键词)" class="layui-input">
        </div>
      </div>
			<div class="layui-form-item">
				<label class="layui-form-label">新闻来源</label>
				<div class="layui-input-block">
					<input type="text" name="source" lay-verify="source" value="{{ old('source') }}" placeholder="请输入来源" autocomplete="off" class="layui-input">
				</div>
			</div>
			...
			<div class="layui-form-item layui-form-text">
				...
				<div class="layui-input-block">
					<textarea name="synopsis" lay-verify="synopsis" placeholder="请输入简介" class="layui-textarea">{{ old('synopsis') }}</textarea>
				</div>
			</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" name="titles" lay-verify="titles" value="{{ old('titles') }}"  autocomplete="off" placeholder="请输入网页标题" class="layui-input">
				</div>
			</div>
			...
			<div class="layui-form-item layui-form-text">
				...
				<div class="layui-input-block">
					<textarea name="keyword" lay-verify="keyword"  placeholder="请输入关键字" class="layui-textarea">{{ old('keyword') }}</textarea>
				</div>
			</div>
			...
			<div class="layui-form-item layui-form-text">
				...
				<div class="layui-input-block">
					<textarea name="description" lay-verify="description" placeholder="请输入描述信息" class="layui-textarea">{{ old('description') }}</textarea>
				</div>
			</div>
      <div class="layui-form-item">
...
<!--       <div class="layui-form-item">
      ...
      <div class="layui-form-item">
        ...
        <div class="layui-input-block">
          <input type="text" name="total_num" lay-verify="total_num" value="{{ old('total_num') }}" placeholder="请输入览数" autocomplete="off" class="layui-input">
        </div>
      </div>
			<div class="layui-form-item">
                ...
                <script id="editor" name="content" style="margin-left:40px;margin-top:40px" type="text/plain">@php echo old('content') @endphp</script>
