...
@section('content')
    ...
    <div class="x-body">
      ...
      <xblock>
        ...
        <button class="layui-btn" onclick="x_admin_open('添加用户','./admin-add.html')"><i class="layui-icon"></i>添加</button>
      ...
      <table class="layui-table">
        ...
        <tbody>
          <tr>
            ...
            <td class="td-status">
              <span class="layui-btn layui-btn-normal layui-btn-mini" onclick="member_stop(this,'10001')">已启用</span>
            </td>
            <td class="td-manage">
              <a onclick="member_stop(this,'10001')" href="javascript:;" title="启用">
                <i class="layui-icon"></i>
              </a>
              <a title="编辑" onclick="x_admin_open('编辑','member-edit.html',600,400)" href="javascript:;">
                <i class="layui-icon"></i>
              </a>
