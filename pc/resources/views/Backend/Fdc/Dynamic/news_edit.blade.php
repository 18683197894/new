...
<div class="x-body">
	...
	<div class="layui-card-body" style="padding: 15px;">
		<form class="layui-form" action="{{ url('/backend/fdc/dynamic/news-edit') }}" method="post" enctype='multipart/form-data' lay-filter="component-form-group" autocomplete="off">
			@csrf
      ...
      <div class="layui-form-item">
        ...
        <div class="layui-input-block">
          <select name="key" lay-filter="aihao">
            ...
            <option @if($news->key == $k) selected="selected" @endif value="{{ $k }}">{{ $v }}</option>
            @endforeach
          </select>
        </div>
      </div>
