...
<div class="x-body">
	...
	<div class="layui-card-body" style="padding: 15px;">
		<form class="layui-form" action="{{ url('/backend/fdc/dynamic/news-adds') }}" method="post" enctype='multipart/form-data' lay-filter="component-form-group" autocomplete="off">
			@csrf
