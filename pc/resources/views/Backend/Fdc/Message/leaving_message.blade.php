    ...
    var $ = layui.jquery;
      ...
      function message_code(obj,id)
      {
          ...
          area: ['300px', '100px'] //自定义文本域宽高
                ...
                $.ajax(
                {
                  url : '{{ url("/backend/fdc/message/leaving-message_code") }}',
                  type : 'post',
                  ...
                  success : function(res)
                  {
                    ...
                    { 
                      layer.close(index);
                      $(obj).parents('tr').find('td').eq(8).find('a').html('已处理');
                      $(obj).parents('tr').find('td').eq(8).find('a').removeClass('layui-btn-danger');
                      $(obj).parents('tr').find('td').eq(8).find('a').addClass('layui-btn-normal');
        ...
        function message_stop(obj,id)
        {
          ...
          layer.confirm(itps,function(index){
            $.ajax({
              'url':'{{ url("/backend/fdc/message/leaving-message_status") }}',
      ...
      function message_del(obj,id){
          layer.confirm('确认要删除吗？',function(index){
              ...
              $.ajax({
                url : '{{ url("/backend/fdc/message/leaving-message_del") }}',
                type : 'post',
