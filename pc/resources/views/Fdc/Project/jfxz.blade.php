...
<div class="House">
    ...
    <div class="Apartment">
        ...
        <div class="ApartmentTu">
            <img src="{{ asset('/front/fdc/img/ApartmentTu_img.png') }}" alt="" class="ApartmentTu_img"/>
            <div class="Content">
                ...
                <span class="Tel">028-62230059</span>
            </div>
        </div>
        <div class="ApartmentTu">
            <img src="{{ asset('/front/fdc/img/ApartmentTu_img.png') }}" alt="" class="ApartmentTu_img"/>
    ...
    <div class="Guanggao">
        <img src="{{ asset('/front/fdc/img/House_guanggao.png') }}" alt=""/>
    </div>
    <div class="Sample">
        <div class="Taitou">万贯金府星座样板间</div>
        <div class="Sample_L">
            <div class="Title"><span>75</span><span>.59</span>㎡居住型样板间</div>
            <a href="#">
                <img src="{{ asset('/front/fdc/img/Sample_Show1.png') }}" alt=""/>
            </a>
            <a href="#">
                <img src="{{ asset('/front/fdc/img/Sample_Show2.png') }}" alt=""/>
            </a>
            <a href="#">
                <img src="{{ asset('/front/fdc/img/Sample_Show3.png') }}" alt=""/>
            </a>
        </div>
        <div class="Sample_L">
            <div class="Title"><span>47</span>㎡办公型样板间</div>
            <a href="#">
                <img src="{{ asset('/front/fdc/img/Sample_Show4.png') }}" alt=""/>
            </a>
            <a href="#">
                <img src="{{ asset('/front/fdc/img/Sample_Show5.png') }}" alt=""/>
            </a>
            <a href="#">
                <img src="{{ asset('/front/fdc/img/Sample_Show6.png') }}" alt=""/>
            </a>
        </div>
        <div class="Sample_L">
            <div class="Title"><span>47</span>㎡居住型样板间</div>
            <a href="#">
                <img src="{{ asset('/front/fdc/img/Sample_Show7.png') }}" alt=""/>
            </a>
            <a href="#">
                <img src="{{ asset('/front/fdc/img/Sample_Show8.png') }}" alt=""/>
            </a>
            <a href="#">
                <img src="{{ asset('/front/fdc/img/Sample_Show9.png') }}" alt=""/>
            </a>
        </div>
    </div>
