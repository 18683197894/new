...
/*
    同步加载页面内容，此方法仅供加载本地页面(同项目下的，不支持跨域)
 */
          ...
          $(".layui-form-checkbox").click(function(event) {
            if($(this).hasClass('layui-form-checked')){
                ...
                if($(this).hasClass('role')){
                    $('.roles').removeClass('layui-form-checked');
                }
            }else{
                ...
                if($(this).hasClass('role')){
                    $('.roles').addClass('layui-form-checked');
                }
            }
...
function layMsgOk(message,fun=null) {
	layer.msg(message, {icon:1,time:2000},fun);
}
function layMsgError(message,fun=null) {
	layer.msg(message, {icon:2, anim:6,time:2000},fun);
}