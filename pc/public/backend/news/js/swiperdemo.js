...
!function (t) {
    ...
    A.prototype = {
        ...
        init: function (element,data) {
            ...
            //复制幻灯片第一和最后
            var first_child = this.element.find('a')[0];
            var last_child = this.element.find('a')[this.list_child-1];
        ...
        adaption: function () {
            ...
            this.element.find('a').css({'width': this.box_left, 'height': this.box_left/this.data.ratio});
